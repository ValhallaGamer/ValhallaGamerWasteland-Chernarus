...
"1.0",
"
Initial Release based on 404Games Wasteland and further developed by Valhalla Gamer<br/>
"
]
];

player createDiaryRecord["ValhallaGamer",
[
"Credits",
"
	Valhalla Gamer - Wasteland Development Team:<br/><br/>
		Sim<br/>
		Agent<br/>
"
]
...
"
<br/>
	Found a bug? Please report it at: http://www.valhallagamer.com<br/><br/>
	Suspect a player is hacking or exploiting? Please report it at: http://www.valhallagamer.com<br/><br/>
"
]
];
...
<br/>
	...
	Teamspeak IP: ts3.valhallagamer.com<br/><br/>
...
"
The Wasteland is a team versus team versus team sandbox survival experience. The objective of this mission is to rally your faction, scavenge supplies, weapons, and vehicles, and destroy the other factions. It is survival at its best! Keep in mind this is a work in progress, please direct your reports to Valhalla Gamer.
<br/><br/>
...
A. Simply go into global chat and get the attention of one of the admins or visit www.valhallagamer.com and make a report if the offence is serious.
<br/>
"]
];