...
else
{
	...
	if !(isNil "_est_calculateur") then {
		...
		else
		{
			...
			_action_menu_release_relative = player addAction [("<img image='client\icons\r3f_release.paa'/><t color=""#21DE31"">" + STR_R3F_LOG_action_relacher_objet + "</t>"), "addons\R3F_ARTY_AND_LOG\R3F_LOG\objet_deplacable\relacher.sqf", false, 5, true, true];
			_action_menu_release_horizontal = player addAction [("<img image='client\icons\r3f_releaseh.paa'/><t color=""#21DE31"">" + STR_RELEASE_HORIZONTAL + "</t>"), "addons\R3F_ARTY_AND_LOG\R3F_LOG\objet_deplacable\relacher.sqf", true, 5, true, true];
			_action_menu_45 = player addAction [("<img image='client\icons\r3f_rotate.paa'/><t color=""#dddd00"">Rotate object 45°</t>"), "addons\R3F_ARTY_AND_LOG\R3F_LOG\objet_deplacable\rotate.sqf", 45, 4, true, true];
			_action_menu_90 = player addAction [("<img image='client\icons\r3f_rotate.paa'/><t color=""#dddd00"">Rotate object 90°</t>"), "addons\R3F_ARTY_AND_LOG\R3F_LOG\objet_deplacable\rotate.sqf", 90, 4, true, true];
			_action_menu_180 = player addAction [("<img image='client\icons\r3f_rotate.paa'/><t color=""#dddd00"">Rotate object 180°</t>"), "addons\R3F_ARTY_AND_LOG\R3F_LOG\objet_deplacable\rotate.sqf", 180, 4, true, true];
