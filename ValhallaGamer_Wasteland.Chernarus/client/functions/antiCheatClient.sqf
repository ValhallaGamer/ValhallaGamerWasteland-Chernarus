...
_bannedVehicles = [
	"F35B","A10","AV8B","C130","C130J","CruiseMissile1","CruiseMissile2","Ka52","RM70_ACR","T810_Des_ACR","T810_ACR","T810Reammo_ACR",
    ...
    "Mi171Sh_rockets_CZ_EP1","UH1H_TK_EP1","Su34","BAF_Apache_AH1_D","Mi24_D_CZ_ACR","AW159_Lynx_BAF","M1114_AGS_ACR","M1114_DSK_ACR"];
