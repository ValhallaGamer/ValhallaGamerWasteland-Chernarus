...
//Anti Vehicle
_leader = _group createunit ["Woodlander1", [(_pos select 0) + 10, _pos select 1, 0], [], 0.5, "Form"];
...
//Sniper
_man4 = _group createunit ["Woodlander2", [_pos select 0, (_pos select 1) - 30, 0], [], 0.5, "Form"];
