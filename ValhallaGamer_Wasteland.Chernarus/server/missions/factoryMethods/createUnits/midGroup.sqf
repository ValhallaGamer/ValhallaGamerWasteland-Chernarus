...
//Support
_man2 = _group createunit ["Woodlander2", [(_pos select 0) - 30, _pos select 1, 0], [], 0.5, "Form"];
...
//Rifle_man
_man3 = _group createunit ["Woodlander1", [_pos select 0, (_pos select 1) + 30, 0], [], 0.5, "Form"];
